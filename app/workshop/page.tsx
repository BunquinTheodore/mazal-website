...
import WhatYoullLearn from '@/components/workshop/WhatYoullLearn';
...
export const metadata: Metadata = {
  title: 'Free Beginner Trading Workshop | MAZAL',
  description:
    'Perfect for those who don’t know anything about trading. Join the free MAZAL beginner workshop, powered by GN Club.',
};

const heroGallery: PhotoSlot[] = [
  ...
  { filename: 'trading-03.jpg', alt: 'Close-up of a trading dashboard on a laptop screen', description: 'Close-up of charts/dashboard on a competitor’s laptop' },
  ...
  { filename: 'trading-05.jpg', alt: 'Group photo of the trading competition participants', description: 'Group / team photo of attendees' },
  { filename: 'trading-06.jpg', alt: 'Prize giveaway moment at the trading competition', description: 'Prize or merch giveaway moment on stage' },
];
  ...
  return (
    <>
      ...
      <div className="wpage">
        <main>
          <WorkshopHero
            eyebrow="Mazal Beginner Workshop"
            headline={<>Perfect for those who don&rsquo;t know<br /><span className="g">anything about trading.</span></>}
            subline="A free beginner workshop by MAZAL, powered by GN Club. No experience needed, just show up ready to learn."
            ctaLabel="Join Now"
          />
          ...
          <WhoItsFor
            items={[
              'Never traded before in your life',
              'Curious about crypto but don’t know where to start',
              'Want to learn the right way, with a community behind you',
            ]}
          />
          ...
          <section id="gallery">
            <Reveal as="div" className="wrap center rv">
              <span className="eyebrow">The trading competition</span>
          ...
          <HowItWorks
            steps={[
              { title: 'Deposit $50 USD', body: 'Deposit $50 USD to your own LBank account. This money stays yours, always.' },
              { title: 'Fill up the form', body: 'Submit the sign-up form below with your proof of deposit and a few details.' },
              { title: 'Get your slot', body: 'We confirm your spot and send you everything you need for workshop day.' },
            ]}
          />
          ...
          <section id="signup">
            <Reveal as="div" className="wrap center rv">
              ...
              <h2><Words>Reserve your <span className="g">workshop slot</span></Words></h2>
            ...
            <Reveal as="div" className="wrap rv">
              <div className="wformwrap">
                <SignupForm workshopType="beginner" />
                <div className="photo-placeholder ph-form" role="img" aria-label="Photo of a MAZAL team member helping a workshop participant fill out the sign-up form">
          ...
          <section id="cta-repeat">
            <Reveal as="div" className="wrap center rv">
              <h2><Words>Ready to <span className="g">start learning</span>?</Words></h2>
