    ...
    <footer>
      <div className="wrap">
        <div className="fgrid">
          ...
          <div>
            <h4>Community</h4>
            <a href="https://discord.gg/Mazal" target="_blank" rel="noopener">Discord</a>
          ...
          <div>
            <h4>Contact</h4>
            <a href="https://discord.gg/Mazal" target="_blank" rel="noopener">Message us on Discord</a>
        ...
        <div className="legal">
          ...
          <span>discord.gg/Mazal · @MazalOfficialPH</span>
        </div>
      </div>
    </footer>
  );
